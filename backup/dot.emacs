...
(require 'uniquify)
(setq uniquify-buffer-name-style                          'reverse)
>>>>>>> 92b56e884696110eec237109125bd034d53cc2ed
...
(yas/initialize)
(yas/load-directory (expand-file-name "~/emacs/yasnippet/snippets"))
...
;;; Emacs Load Path
(setq load-path (cons "~/emacs/google-weather-el" load-path))
